...
Amicable WordPress Theme, Copyright (C) 2019-2020, Benjamin Lu
Amicable is distributed under the terms of the GNU GPL

== Description ==
Amicable is a ClassicPress theme that gives users the ability to create blogs
...
== Changelog ==
Version: 1.0.2 
- Update Manager by CodePotent added
