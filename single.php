			...
			<main id="main" class="content-area">
				<?php
					...
					endwhile;
						the_post_navigation(
							array(
								'next_text' => '<span class="post-next" aria-hiddent="true">' . esc_html__( 'Next', 'amicable' ) . '</span><span class="post-title">%title</span>',
								'prev_text' => '<span class="post-previous" aria-hidden="true">' . esc_html__( 'Previous', 'amicable' ) . '</span><span class="post-title">%title</span>',
							)
						);
				comments_template();
				?>
